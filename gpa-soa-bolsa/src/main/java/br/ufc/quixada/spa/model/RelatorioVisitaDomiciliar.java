...
import br.ufc.soa.Enums.EstadoMoradia;
...
public class RelatorioVisitaDomiciliar {
	...
	public RelatorioVisitaDomiciliar(Integer id2) {
		this.id = id2;
	}
	...
	@NotNull(message = "Campo oobrigatorio")
	...
	public String toString() {
		return "RelatorioVisitaDomiciliar [id=" + id + ", candidato="
				+ idAluno + ", endereco=" + endereco + ", formaAcessoCasa="
